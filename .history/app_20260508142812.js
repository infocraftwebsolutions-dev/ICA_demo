...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* HERO + CTA CANVAS */
  initHeroParticles(prefersReduced, motionState);
  initCtaParticles(prefersReduced, motionState);
...
function initHeroParticles(reduced, motionState) {
...
function initCtaParticles(reduced, motionState) {
